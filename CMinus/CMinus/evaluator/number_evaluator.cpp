...
cminus::evaluator::object::memory_ptr_type cminus::evaluator::number::evaluate_unary_left(operators::id op, memory_ptr_type target) const{
	return arithmetic::evaluate(op, target, true);
}

cminus::evaluator::object::memory_ptr_type cminus::evaluator::number::evaluate_unary_right(operators::id op, memory_ptr_type target) const{
	return arithmetic::evaluate(op, target, false);
}

cminus::evaluator::object::memory_ptr_type cminus::evaluator::number::evaluate_binary_(operators::id op, memory_ptr_type left_value, node_ptr_type right) const{
