...
namespace cminus::evaluator{
	...
	protected:
		...
		object::memory_ptr_type evaluate_(operators::id op, object::memory_ptr_type left, object::memory_ptr_type right) const{
		...
		template <typename target_type>
		object::memory_ptr_type evaluate_integral_(operators::id op, object::memory_ptr_type left, object::memory_ptr_type right) const{
