...
bool cminus::type::proxy::is_forward_traversable() const{
	return target_->is_forward_traversable();
}

bool cminus::type::proxy::is_reverse_traversable() const{
	return target_->is_reverse_traversable();
}
