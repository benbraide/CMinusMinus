...
cminus::adapter::string::string(std::size_t size, char value){
	...
	value_ = decl->evaluate(0u, std::list<std::shared_ptr<memory::reference>>{
...
bool cminus::adapter::string::empty() const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("IsEmpty")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
	return (result->read_scalar<type::boolean_constant>() == type::boolean_constant::true_);
}

std::size_t cminus::adapter::string::size() const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("GetSize")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
	return result->read_scalar<std::size_t>();
}

const char *cminus::adapter::string::data() const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("GetData")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
...
const char *cminus::adapter::string::begin() const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("Begin")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
	return reinterpret_cast<char *>(runtime::object::memory_object->get_block(result->read_scalar<std::size_t>())->get_data());
}

const char *cminus::adapter::string::end() const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("End")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
	return reinterpret_cast<char *>(runtime::object::memory_object->get_block(result->read_scalar<std::size_t>())->get_data());
}

char cminus::adapter::string::at(std::size_t position) const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("At")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
...
std::size_t cminus::adapter::string::find(const std::string_view &value, std::size_t offset) const{
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("Find")->call(value_, std::list<std::shared_ptr<memory::reference>>{
...
void cminus::adapter::string::resize(std::size_t size, char fill){
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("Resize")->call(value_, std::list<std::shared_ptr<memory::reference>>{
		std::make_shared<memory::scalar_reference<std::size_t>>(storage::get_cached_type<std::size_t>::type(), size),
...
void cminus::adapter::string::erase(std::size_t position, std::size_t size){
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("Erase")->call(value_, std::list<std::shared_ptr<memory::reference>>{
...
void cminus::adapter::string::clear(){
	auto result = runtime::object::global_storage->get_raw_string_type()->find_function("Clear")->call(value_, std::list<std::shared_ptr<memory::reference>>{});
	data_ = runtime::object::global_storage->get_string_value(value_).data();
}
